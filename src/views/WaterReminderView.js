...
export default class WaterReminderView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      reminder: ['2:2'],
  ...
  setReminder(reminder_day) {
    ...
    if (update['weekDayName' + reminder_day]) {
      this.setState({
        reminder: this.state.reminder.concat('2:' + reminder_day),
      });
    } else {
      this.removeDay('2:' + reminder_day);
    }
            ...
            <ScrollView contentContainerStyle={{flexGrow: 1}}>
              <View
                ...
                <View style={{alignItems: 'center', top: 70, height: 200}}>
                  <Image source={require('../img/glass-full-front.png')} />
                  <Text
                    style={{
                      textAlign: 'center',
                      width: 230,
                    ...
                    {translate('WaterReminderView.Text1')}
                  </Text>
                  <Text
                    style={{
                      textAlign: 'center',
                    ...
                    {translate('WaterReminderView.Text2')}
                  </Text>
                </View>
