...
export default class ApprovedAccountView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      passwordShow: false,
  ...
  async approveAccount() {
    ...
    formdata.append('signup_state', 2);
  ...
  shareWithFriends() {
    let url = 'https://scale-app.com';
    let title = 'ScaleApp - Fitness App';
    let message =
      'רציתי לשתף אותך באפליקציה שאני משתמש - סקיילאפ: אפליקציה לאורח חיים בריא. לעוד פרטים: ';
      ...
      <TouchableWithoutFeedback
        ...
        <SafeAreaView style={[styles.mainContainer]}>
          <ImageBackground
            ...
            <ImageBackground
              ...
              <Text
                style={[
                  styles.textStyle,
                  {color: 'white', alignSelf: 'center', marginTop: 30},
                ]}>
                {translate('ApprovedAccountView.Text1')}
              </Text>
            </ImageBackground>
          </ImageBackground>
          ...
          <ImageBackground
            ...
            style={{marginTop: -300, width: 331, height: 384}}>
            <View style={{flexDirection: 'column', height: '100%'}}>
              ...
              <View
                ...
                <Text
                  ...
                  {translate('ApprovedAccountView.Text2')} {'\n'}
                  {translate('ApprovedAccountView.Text3')} {'\n'}
                  {translate('ApprovedAccountView.Text4')}{' '}
                </Text>
                <Text style={styles.textStyleSmallBold}>
                  1 {translate('ApprovedAccountView.Text8')}
                </Text>
                <Text
                  style={[
                    styles.textStyleSmall,
                  ...
                  {translate('ApprovedAccountView.Text5')} {'\n'}
                  {translate('ApprovedAccountView.Text6')} {'\n'}
                  {translate('ApprovedAccountView.Text7')}
                </Text>
              </View>
              <View
                style={{
                ...
                <View style={{flexDirection: 'column'}}>
                  <Text style={styles.textStyleSmallBold}>0</Text>
                  <Text style={styles.textStyleSmall}>
                    {translate('ApprovedAccountView.Text9')}
                  </Text>
                </View>
                <View
                  style={{
                ...
                <View style={{flexDirection: 'column'}}>
                  <Text style={styles.textStyleSmallBold}>1</Text>
                  <Text style={styles.textStyleSmall}>
                    {translate('ApprovedAccountView.Text10')}
                  </Text>
                </View>
              </View>
            </View>
            ...
            <TouchableOpacity
              ...
              <LinearGradient
                ...
                <Text style={{color: '#fff', fontSize: 18, fontWeight: 'bold'}}>
                  {translate('common.shareToFriends')}
                </Text>
              </LinearGradient>
            </TouchableOpacity>
            <TouchableOpacity onPress={() => this.approveAccount()}>
              <Text
                style={[
                  styles.textStyleSmall,
                  {color: '#7265E3', alignSelf: 'center', marginTop: 10},
                ]}>
