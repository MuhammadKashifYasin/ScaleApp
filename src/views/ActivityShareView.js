...
const {styles} = Styles;
export default class ActivityShareView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      passwordShow: false,
          ...
          <ImageBackground
            ...
            <ImageBackground
              ...
              <Text
                ...
                {translate('ActivityShareView.Text1')} {'\n'}{' '}
                {translate('ActivityShareView.Text2')}
              </Text>
            </ImageBackground>
          </ImageBackground>
              ...
              <View
                ...
                <View style={{flexDirection: 'column'}}>
                  ...
                  <Text style={styles.textStyleSmall}>
                    {translate('ActivityShareView.Text3')}
                  </Text>
                </View>
                <View
                  style={{
                ...
                <View style={{flexDirection: 'column'}}>
                  ...
                  <Text style={styles.textStyleSmall}>
                    {translate('ActivityShareView.Text4')}
                  </Text>
                </View>
              </View>
            </View>
