import {
  ...
  const {styles} = Styles;
  export default class ActivityComponentView extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
        passwordShow: false,
    ...
    render() {
      return (
        <SafeAreaView style={[styles.mainContainer]}>
          ...
          <TouchableOpacity
            onPress={()=> this.props.navigation.navigate('ActivityFrontView')}
            ...
            <View style={{flexDirection: 'column', height: '100%'}}>
              ...
              <View
                ...
                style={{justifyContent: 'center',alignSelf: 'center',marginTop: '10.42%'}}
                />
              ...
              <View
                ...
                <View style={{flexDirection: 'column'}}>
                  <Text style={styles.textStyleSmallBold}>01:30</Text>
                ...
                <View style={{flexDirection: 'column'}}>
                  <Text style={[styles.textStyleSmallBold,{justifyContent: 'center',alignSelf: 'center'}]}>1:00</Text>
