...
const dayNames = [
  {
    name: translate('common.Text3'),
    backGroundColor: '#F4F6FA',
    reminder_day: 2,
  },
  {
    name: translate('common.Text4'),
    backGroundColor: '#F4F6FA',
    reminder_day: 3,
  },
  {
    name: translate('common.Text5'),
    backGroundColor: '#F4F6FA',
    reminder_day: 4,
  },
  {
    name: translate('common.Text6'),
    backGroundColor: '#F4F6FA',
    reminder_day: 5,
  },
  {
    name: translate('common.Text7'),
    backGroundColor: '#F4F6FA',
    reminder_day: 6,
  },
  {
    name: translate('common.Text8'),
    backGroundColor: '#F4F6FA',
    reminder_day: 7,
  },
  {
    name: translate('common.Text9'),
    backGroundColor: '#F4F6FA',
    reminder_day: 1,
  },
];

export default class ActivityReminderView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      reminder: ['5:2'],
  ...
  setReminder(reminder_day) {
    ...
    if (update['weekDayName' + reminder_day]) {
      this.setState({
        reminder: this.state.reminder.concat('5:' + reminder_day),
      });
    } else {
      this.removeDay('5:' + reminder_day);
    }
              ...
              <View
                ...
                <View style={{alignItems: 'center', top: 70, height: 200}}>
                  ...
                  <Text
                    ...
                    {translate('ActivityReminderView.Text1')}
                  </Text>
                  <Text
                    style={{
                      textAlign: 'center',
                    ...
                    {translate('ActivityReminderView.Text2')}
                  </Text>
                </View>
