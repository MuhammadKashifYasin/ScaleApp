...
export default class NutritionReminderView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      option: 2,
  ...
  setReminder(reminder_day) {
    ...
    if (update['weekDayName' + reminder_day]) {
      this.setState({
        reminder: this.state.reminder.concat('1:' + reminder_day),
      });
    } else {
      this.removeDay('1:' + reminder_day);
    }
              ...
              <View
                ...
                <View style={{alignItems: 'center', top: 70, height: 200}}>
                  ...
                  <Text
                    ...
                    {translate('NutritionReminderView.Text1')}
                  </Text>
                  <Text
                    style={{
                      textAlign: 'center',
                    ...
                    {translate('NutritionReminderView.Text2')}
                  </Text>
                </View>
