...
export default class WeightReminderView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      reminder: ['4:2'],
  ...
  setReminder(reminder_day) {
    ...
    if (update['weekDayName' + reminder_day]) {
      this.setState({
        reminder: this.state.reminder.concat('4:' + reminder_day),
      });
    } else {
      this.removeDay('4:' + reminder_day);
    }
            ...
            <ScrollView contentContainerStyle={{flexGrow: 1}}>
              <View
                ...
                <View style={{alignItems: 'center', top: 70, height: 200}}>
                  <Image source={require('../img/weight-reminder.png')} />
                  <Text
                    style={{
                      textAlign: 'center',
                      width: 230,
                    ...
                    {translate('WeightReminderView.Text1')}
                  </Text>
                  <Text
                    style={{
                      textAlign: 'center',
                    ...
                    {translate('WeightReminderView.Text2')}
                  </Text>
                </View>
