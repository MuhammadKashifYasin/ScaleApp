...
const {styles} = Styles;
export default class WaterShareView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      passwordShow: false,
          ...
          <ImageBackground
            ...
            <ImageBackground
              ...
              <Text
                ...
                {translate('WaterShareView.Text5')}
              </Text>
            </ImageBackground>
          </ImageBackground>
            ...
            <View style={{flexDirection: 'column', height: '100%'}}>
              ...
              <View
                ...
                <Text
                  ...
                  9/8 {translate('WaterShareView.Text1')}
                </Text>
                <Text style={[styles.textStyleSmall, {alignSelf: 'center'}]}>
                  {translate('WaterShareView.Text2')}
                </Text>
              </View>
              <View
                style={{
                ...
                <View style={{flexDirection: 'column'}}>
                  ...
                  <Text style={styles.textStyleSmall}>
                    {translate('WaterShareView.Text1')}
                  </Text>
                </View>
                <View
                  style={{
                ...
                <View style={{flexDirection: 'column'}}>
                  ...
                  <Text style={styles.textStyleSmall}>
                    {translate('WaterShareView.Text4')}
                  </Text>
                </View>
              </View>
            </View>
