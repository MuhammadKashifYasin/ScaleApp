...
const {styles} = Styles;
export default class NutritionShareView extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      passwordShow: false,
          ...
          <ImageBackground
            ...
            <ImageBackground
              ...
              <Text
                ...
                {translate('NutritionShareView.Text1')}
              </Text>
            </ImageBackground>
          </ImageBackground>
            ...
            <View style={{flexDirection: 'column', height: '100%'}}>
              ...
              <View
                ...
                <Text
                  ...
                  1830 {translate('NutritionShareView.Text2')}
                </Text>
                <Text style={[styles.textStyleSmall, {alignSelf: 'center'}]}>
                  {translate('NutritionShareView.Text3')}
                </Text>
              </View>
              <View
                style={{
                ...
                <View style={{flexDirection: 'column'}}>
                  ...
                  <Text style={styles.textStyleSmall}>
                    {translate('NutritionShareView.Text4')}
                  </Text>
                </View>
                <View
                  style={{
                ...
                <View style={{flexDirection: 'column'}}>
                  ...
                  <Text style={styles.textStyleSmall}>
                    {translate('NutritionShareView.Text5')}
                  </Text>
                </View>
              </View>
            </View>
